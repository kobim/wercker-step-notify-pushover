...
export WERCKER_NOTIFY_PUSHOVER_MESSAGE="<$WERCKER_APPLICATION_URL|$WERCKER_APPLICATION_NAME> $WERCKER_NOTIFY_PUSHOVER_ACT #${WERCKER_DEPLOY_ID:0:5} by $WERCKER_STARTED_BY $WERCKER_RESULT."
